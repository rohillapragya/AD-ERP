...
@endphp
	...
	<nav aria-label="breadcrumb">
	 ...
	 <div class="container box-shadow">
        @if($user_role_id=='1' || $user_role_id=='2' || $is_admin_access_for_active_location=='Y' || Dashboard::isRouteExistForUser('/dashboard/dispatchService')=='YES')

            @if($user_role_id=='1' || $user_role_id=='2' || $is_admin_access_for_active_location=='Y' || Dashboard::isRouteExistForUser('/dashboard/addNewDistapchService')=='YES')
            ...
            <div class="form-group row">
                <table class="table table-bordered" id="dispatchServiceList">
                    ...
                    <tbody style="font-size: 14px;" >
                        @if(count($output) > 0)
                            @for ($i = 0; $i < count($output); $i++)
                                <tr>
                                    ...
                                    @if($user_role_id=='1' || $user_role_id=='2' || $is_admin_access_for_active_location=='Y' || Dashboard::isRouteExistForUser('/dispatch/service/edit/{serviceId}')=='YES')
                        ...
                        @else  
                            <tr>
                                <td colspan="6" class="no-data-found">No Dispatch Service found</td>
                            </tr>
                        @endif    
                    </tbody>
                </table>
