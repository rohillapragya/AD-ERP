    ...
    <div class="col-lg-4 col-sm-4"> 
        <div class="panel panel-default boxShadow">
            ...
            <!-- add inquiry section start -->
                ...
                <a href="#" class="panel-content" style="margin-bottom: 24%"><span>Add Inquiry</span></a>
        ...
        <div class="panel panel-default boxShadow">
            ...
            <!-- dispatch service info section start -->
                ...
                @if($user_role_id=='3' || $user_role_id=='7' || $user_role_id=='12')
                    ...
                    <a href="/dashboard/dispatchInfo"><span>Dispatch Info</span></a>
                @else
        ...
        <div class="panel panel-default boxShadow">
            ...
            <!-- QC section start here -->
                ...
                @if($user_role_id=='3' || $user_role_id=='10')
                    <a href="#" class="panel-content"><span>Batch No</span></a>
                    <a href="#"><span>COA Details</span></a>
                @else
                    <span class="panel-content">Batch No</span>
