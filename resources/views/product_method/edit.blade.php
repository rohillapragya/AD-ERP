...
@endphp
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"> <a href="/dashboard"> Dashboard </a> /  Method /  Edit</li>
    </ol>
    </nav>
    ...
    <div class="container box-shadow">
        ...
        <form method="post" action="/product/editMethod">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="input" class="form-control" id="method_name" name="method_name" placeholder="method name" required="required"  value="{{ $output[0]['name'] }}">
                </div>
            </div>
