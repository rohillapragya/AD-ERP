...
@endphp
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"> <a href="/dashboard"> Dashboard </a> /  Bill of Material(BOM) - Production  /  Add </li>
    </ol>
    </nav>
...
<script src="{{ asset('js/production/init-edit.js') }}"></script>
