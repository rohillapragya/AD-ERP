    ...
    <div class="container box-shadow">
        <form method="post" action="/customer/sample/readyForDispatch">
            ...
            <div class="row">
                ...
                <div class="col-md-8 card-block-detail">{{ isset($BMR_details[0]["bmr"] ) ? $BMR_details[0]["bmr"]  : '' }}</div>
            </div>

            <div class="row">
                <div class="col-md-4 card-block-header">Status</div>
                <div class="col-md-8 card-block-detail">{{ isset($BMR_details[0]["description"] ) ? $BMR_details[0]["description"]  : '' }}</div>
            </div>

            <div class="row">
                <div class="col-md-4 card-block-header">Remarks</div>
                <div class="col-md-8 card-block-detail">{{ isset($BMR_details[0]["remarks"] ) ? $BMR_details[0]["remarks"]  : '' }}</div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 card-block-detail">
                  <input type="checkbox" value="1" required="required" name="readyForDispatch">
                    <span style="margin-left: 1%;text-transform: initial;">Have you read above information ?. After proceed for dispatch you will not be able to edit it.</span>
                </div>  
            </div>
