...
@php
    ...
    $received_date = $output[0]['received_date'];
    $deli_date_arr = explode("-",$received_date);
...
@endphp
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"> <a href="/dashboard"> Dashboard </a> /   Vendor  Sample Edit</li>
    </ol>
    </nav>
