...
@endphp
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"> <a href="/dashboard"> Dashboard </a> /  Vendor /  Edit</li>
    </ol>
    </nav>
    ...
    <div class="container box-shadow">
    	@if($user_role_id=='1' || $user_role_id=='2' || $is_admin_access_for_active_location=='Y' || Dashboard::isRouteExistForUser('/dashboard/editVendor')=='YES')
    	<form method="post" action="/dashboard/editVendor">
           	{{ csrf_field() }}
	    	...
	    	<input type="hidden" id="primaryproduct" value="{{ $getUserCompanyInformation[0]['primary_product'] }}">
	    	<input type="hidden" id="vendorId" name="vendorId" value="{{ $vendor_registration_output[0]['Id'] }}">
	    	<input type="hidden" id="cityValue" value="{{ $vendor_registration_output[0]['city_code'] }}">
	                ...
	                <div class="card card-class">
	                    ...
	                    <div class="card-body">
	                        ...
	                        <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    <input type="input" class="form-control" id="name_of_business" name="name_of_business" placeholder="comapny name" required="required"  value="{{ $vendor_registration_output[0]['company_name'] }}">
				                </div>
				            </div>
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    <input type="input" class="form-control" id="name_address_vendor_code" name="name_address_vendor_code" placeholder="vendor coode" required="required" value="{{ $vendor_registration_output[0]['user_master_type_code'] }}">
				                </div>
				            </div>
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    ...
				                    <textarea class="form-control" id="name_address_address" name="name_address_address" placeholder="address" required="required">{{ $vendor_registration_output[0]['address'] }}</textarea>
				                </div>
				            </div>
				                    ...
				                    <div class="day-month-yaer-class">
				                        ...
				                        <select class="form-control date-class" id="name_address_business_state_name" name="name_address_business_state_name" onchange="onChangeState(this)">
				                            @for ($ix = 0; $ix < count($state); $ix++) 
	                                            @if($vendor_registration_output[0]['state_id']==$state[$ix]['id'])
				                        ...
				                        <select class="form-control date-class" id="name_address_business_city_name" name="name_address_business_city_name">
				                          <!--   @for ($i = 0; $i < count($city); $i++)
				                            ...
				                            @for ($ix = 0; $ix < count($city); $ix++) 
	                                            @if($vendor_registration_output[0]['city_code']==$city[$ix]['id'])
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    <input type="number" class="form-control" id="name_address_pin" name="name_address_pin" placeholder="pin" required="required" value="{{ $vendor_registration_output[0]['pin_code'] }}" minlength="6" maxlength="6">
				                </div>
				            </div>
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                   	<div class="day-month-yaer-class">
				                   		<input type="number" class="form-control" id="name_address_mobile" name="name_address_mobile" placeholder="mobile" required="required" style="margin-right: 5%" value="{{ $vendor_registration_output[0]['mobile'] }}" minlength="10" maxlength="10">

				                      	<input type="email" class="form-control" id="name_address_email" name="name_address_email" placeholder="email" value="{{ $vendor_registration_output[0]['email'] }}">
				                    </div>
				                </div>
				            </div>
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    <input type="input" class="form-control" id="name_address_pan_no" name="name_address_pan_no" placeholder="pan no" required="required" value="{{ $vendor_registration_output[0]['pan_no'] }}">
				                </div>
				            </div>
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    <input type="input" class="form-control" id="name_address_cin_no" name="name_address_cin_no" placeholder="cin no" value="{{ $vendor_registration_output[0]['cin_no'] }}">
				                </div>
				            </div>
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    <input type="input" class="form-control" id="name_address_gstn_no" name="name_address_gstn_no" placeholder="gstn no" required="required" value="{{ $vendor_registration_output[0]['gst_no'] }}">
				                </div>
				            </div>
	                ...
	                <div class="card card-class">
	                    ...
	                    <div class="card-body">
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    <input type="text" class="form-control" id="company_information_parent_company" name="company_information_parent_company" placeholder="parent company (If Any..)" value="{{ $getUserCompanyInformation[0]['parent_company_name'] }}">
				                </div>
				            </div>
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    <input type="number" class="form-control" id="in_business_since" name="in_business_since" placeholder="business since" required="required" value="{{ $getUserCompanyInformation[0]['business_since'] }}">
				                </div>
				            </div>
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                   	<div class="day-month-yaer-class">
				                   		<input type="number" class="form-control" id="primary_conatct_mobile" name="primary_conatct_mobile" placeholder="primary mobile" required="required" style="margin-right: 5%" value="{{ $getUserCompanyInformation[0]['primary_mobile_number'] }}" minlength="10" maxlength="10">

				                      	<input type="email" class="form-control" id="primary_conatct_email" name="primary_conatct_email" placeholder="primary email" required="required" value="{{ $getUserCompanyInformation[0]['primary_email'] }}">
				                    </div>
				                </div>
				            </div>
...
<script src="{{ asset('js/userRegistration/vendor-edit.js') }}"></script>
