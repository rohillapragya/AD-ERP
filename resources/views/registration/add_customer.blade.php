...
@endphp
    ...
    <div class="container box-shadow">
    	@if($user_role_id=='1' || $user_role_id=='2' || $is_admin_access_for_active_location=='Y' || Dashboard::isRouteExistForUser('/dashboard/saveCustomer')=='YES')
    	<form method="post" action="/dashboard/saveCustomer">
           	{{ csrf_field() }}
	                ...
	                <div class="card card-class">
	                    ...
	                    <div class="card-body">
	                        ...
	                        <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    <input type="input" class="form-control" id="name_of_business" name="name_of_business" placeholder="comapny name" required="required"  value="{{ old('name_of_business') }}" onblur="checkIfUserExist(id)">
				                </div>
				            </div>
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    <input type="input" class="form-control" id="name_address_gstn_no" name="name_address_gstn_no" placeholder="gstn no" required="required" value="{{ old('name_address_gstn_no') }}" onblur="checkGSTN(id)">
				                </div>
				            </div>
	                ...
	                <div class="card card-class">
	                    ...
	                    <div class="card-body">
	                        ...
	                        <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    <input type="text" class="form-control" id="trade_reference_company_name" name="trade_reference_company_name" placeholder="company name" value="{{ old('trade_reference_company_name') }}">
				                </div>
				            </div>
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    <input type="text" class="form-control" id="trade_reference_contact_name" name="trade_reference_contact_name" placeholder="contact name" value="{{ old('trade_reference_contact_name') }}">
				                </div>
				            </div>
				            ...
				            <div class="form-group row">
				                <label class="col-sm-4 col-form-label">Address</label>
				                <div class="col-sm-8">
				                    <input type="text" class="form-control" id="trade_reference_address" name="trade_reference_address" placeholder="address" value="{{ old('trade_reference_address') }}">
				                </div>
				            </div>
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    <input type="number" class="form-control" id="trade_reference_phone" name="trade_reference_phone" placeholder="phone" value="{{ old('trade_reference_phone') }}">
				                </div>
				            </div>
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    <input type="number" class="form-control" id="trade_reference_ac_opened_since" name="trade_reference_ac_opened_since" placeholder="account opened since" value="{{ old('trade_reference_ac_opened_since') }}">
				                </div>
				            </div>
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    <input type="number" class="form-control" id="trade_reference_credit_limit" name="trade_reference_credit_limit" placeholder="credit limit" value="{{ old('trade_reference_credit_limit') }}">
				                </div>
				            </div>
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-8">
				                    <input type="number" class="form-control" id="trade_reference_current_balance" name="trade_reference_current_balance" placeholder="current balance" value="{{ old('trade_reference_current_balance') }}">
				                </div>
				            </div>
...
<script src="{{ asset('js/userRegistration/customer.js') }}"></script>
