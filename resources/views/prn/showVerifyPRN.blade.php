...
@endphp
    ...
    <div class="container box-shadow">
        @if($user_role_id=='1' || $user_role_id=='2' || $is_admin_access_for_active_location=='Y' || Dashboard::isRouteExistForUser('/dashoard/prn/verify')=='YES')
            ...
            <table class="table table-bordered" id="sampleItemsList">
                <thead style="background-color: #eef1ed;font-size: 14px;">
                    <tr>
                        ...
                        <th scope="col">Required Date(YYYY-MM-DD)</th>
                        <th scope="col">Request Date(YYYY-MM-DD)</th>
                    ...
                    @if(count($output) > 0)
                        @for ($i = 0; $i < count($output); $i++)
                            <tr>
                                ...
                                <td><a href="/prn/show/{{$output[$i]['id']}}"><span class="glyphicon glyphicon-triangle-right"></a></td> 
                            </tr>
                        @endfor
                    @else  
                        <tr>
