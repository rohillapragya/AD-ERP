    ...
    <div class="container box-shadow">
        <form method="post" action="/stock/save">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control" id="stock_entry_description" name="stock_entry_description" placeholder="description" required="required"></textarea>
                </div>
            </div>
                    ...
                    <table class="table table-bordered" id="stockItemsDetails">
                        ...
                        <tbody style="font-size: 14px;">
                            <tr>
                                ...
                                <th>
                                    <input class="form-control qty" id="qty" type="number" name="product_qty[][qty]" placeholder="qty" min="0">
                                </th>
                                ...
                                <th>
                                 ...
                                 <th>
                                    <input class="form-control qty" id="product_sample_qty" type="number" name="product_sample_qty[][product_sample_qty]" placeholder="sample qty" min="0">
                                </th>
