...
{
    var table = document.getElementById("bomItemsDetails");
...
function validateAddress(){
    ...
    var description = document.getElementById("bom_remark");
...
function onkeyupRemarks()
{
    ...
    var remarks = document.getElementById("bom_remark");

    var remarks_len = remarks.textLength;
   
    var remaining_len = max_char - remarks_len;

    var mrn_remark_span = document.getElementById("bom_remark_span");
