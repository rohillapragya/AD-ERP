...
function addSampleNewRow()
{
    ...
    cell_product_sample_qty.innerHTML = "<input class='form-control qty' id='"+product_sample_qty+"' type='number' name='product_sample_qty[][product_sample_qty]' placeholder='sample qty' required='required' min='0'>";
