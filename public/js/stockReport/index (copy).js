...
function populate()
{
    ...
    {
       // console.log(i);
       //console.log("item_qty_inward_control_class[i].innerText-"+item_qty_inward_control_class[i].innerText);
        ...
        //console.log("item_qty_class_value -"+item_qty_class_value[3]+"item_qty_control_class_value-"+item_qty_control_class_value[3]);
