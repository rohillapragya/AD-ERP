...
{
    var table = document.getElementById("prnItemsDetails");
...
function validateAddress(){
    ...
    var description = document.getElementById("prn_remark");
...
function onkeyupRemarks()
{
    ...
    var remarks = document.getElementById("prn_remark");

    var remarks_len = remarks.textLength;
   
    var remaining_len = max_char - remarks_len;

    var prn_remark_span = document.getElementById("prn_remark_span");

    prn_remark_span.innerText=remaining_len+" characters are remaining";
}