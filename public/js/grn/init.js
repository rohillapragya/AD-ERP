...
function addGRNNewRow()
{
    var table = document.getElementById("grnItemsDetails");
    ...
    var cell_product_price = row.insertCell(4);
    var cell_product_uom = row.insertCell(5);
    ...
    cell_product_price.innerHTML = "<input class='form-control qty' id='"+price_id+"' type='number' name='product_price[][price]' placeholder='price' required='required' min='1'>";
