...
function addSampleNewRow()
{
   ...
   // console.log("Row-"+table_tr_count);
    ...
    cell_product_name.innerHTML="<input class='form-control' type='text' id='"+document_name_id+"' name='document_name' placeholder='document name (exp Batch number)' required='required'>";

    cell_product_method.innerHTML = "<input class='form-control' type='text' id='"+document_number_id+"' name='document_number' placeholder='document number (exp NBT19001)' required='required'>";
