$(document).ready(function(){
    ...
    var stockEntryType = document.getElementById("stockEntryType");
    var value = stockEntryType.value;

    var stockEntryTypeDetails = document.getElementById("stockEntryTypeDetailsHidden");
    var stockEntryTypeDetails_value = stockEntryTypeDetails.value;
        ...
        success: function (resp) 
        {
            ...
            for(var i=0;i<length;i++)
            {
               //$('#stockEntryTypeDetails').append("<option value="+resp[i].id+">"+resp[i].name+"</option>");
                if(stockEntryTypeDetails_value==resp[i].id) 
                {
                    $('#stockEntryTypeDetails').append("<option selected value="+resp[i].id+">"+resp[i].name+"</option>");
                }
                else 
                {
                    $('#stockEntryTypeDetails').append("<option value="+resp[i].id+">"+resp[i].name+"</option>");
