function addSampleNewRow()
{
   // console.log("btn clicked");
    var table = document.getElementById("quotationRequestItemsDetails");
...
function onkeyupRemarks()
{
    ...
    var remarks = document.getElementById("quotation_remark");

    var remarks_len = remarks.textLength;
   
    var remaining_len = max_char - remarks_len;

    var quotation_remark_span = document.getElementById("quotation_remark_span");

    quotation_remark_span.innerText=remaining_len+" characters are remaining";
}